...
import com.example.meyepro.databinding.ActivityAdminScheduleSwappingFreeSlotBinding;
...
public class AdminScheduleSwappingFreeSlotActivity extends AppCompatActivity {
ActivityAdminScheduleSwappingFreeSlotBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityAdminScheduleSwappingFreeSlotBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        ID=getIntent().getStringExtra("ID");
//        Toast.makeText(this, ""+ID, Toast.LENGTH_SHORT).show();
        binding.progressBar.setVisibility(View.VISIBLE);
        String intentData = getIntent().getStringExtra("UserIntent");
         user= new Gson().fromJson(intentData,MEYE_USER.class);
...
//                    Toast.makeText(getApplicationContext(), "Successful"+response.body().get(0).getCourseCode(), Toast.LENGTH_SHORT).show();
                    ...
                    AdminScheduleFreeSlotAdapter adapter = new
                            AdminScheduleFreeSlotAdapter(timeSlots, AdminScheduleSwappingFreeSlotActivity.this, "AdminScheduleSwappingFreeSlotActivity" );
...
//                Toast.makeText(AdminScheduleSwappingFreeSlotActivity.this, "", Toast.LENGTH_SHORT).show();
         binding.textViewTeacherNmae.setText(new Gson().toJson(swapping));
                Intent i = new Intent(getApplicationContext(), AdminScheduleSwappingTimeTableSelectActivity.class);
                i.putExtra("SwappingDataIntent",new Gson().toJson(swapping));
                startActivity(i);
//                if(selectVenue!=""){
//
...
//                                    SweetAlertDialog dialog = new SweetAlertDialog(AdminScheduleSwappingFreeSlotActivity.this, SweetAlertDialog.SUCCESS_TYPE)
...
//                                    dialog.show();
//                                }else{
//                                    Toast.makeText(AdminScheduleSwappingFreeSlotActivity.this, ""+reschedule.get("data"), Toast.LENGTH_SHORT).show();
//                                }
//
...
//                            Toast.makeText(AdminScheduleSwappingFreeSlotActivity.this, ""+t, Toast.LENGTH_SHORT).show();
//                        }
//                    });
//                }
//                else{
//                    Toast.makeText(AdminScheduleSwappingFreeSlotActivity.this, "Please Select Venue", Toast.LENGTH_SHORT).show();
//                }
            }
        });
    ...
    public void recyclerviewSelectVenueDrowpdown(String venue, String startTime, String EndTime, String Day , Context context) {
        ...
        swapping.setId(0);
        swapping.setTimeTableIdFrom(user.getId());
        swapping.setDate(getDateFromDayOfWeek(Day));
        swapping.setDay(Day);
        swapping.setStartTime(startTime);
        swapping.setEndTime(venue);
